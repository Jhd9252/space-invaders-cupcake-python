...
RED_SHIP = pygame.image.load(os.path.join("assets", "pixel_snorlax1.png"))
BLUE_SHIP = pygame.image.load(os.path.join('assets','pixel_snorlax2.png'))
GREEN_SHIP = pygame.image.load(os.path.join('assets','pixel_snorlax3.png'))

# player image asset
YELLOW_SHIP = pygame.image.load(os.path.join("assets", "pixel_cupcake.png"))
